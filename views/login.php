...
<head>
    ...
    <title>∆H › L › Войдите</title>
    <link href="client/style.css" rel="stylesheet" type="text/css" />
</head>
<body class="white">
	<div id="help">
		<div class="title">∆H</div>
		<p>HTML игра на JavaScript'е с использованием Socket.IO </p>
		...
		<p>P.S. Игра в стадии тестирования. <a href="https://github.com/latur/dH" target="_blank">Исходный код.</a></p>
		<img src="client/img/demo-1.jpg" /> <img src="client/img/demo-2.jpg" />
